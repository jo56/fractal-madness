...
pub fn presets() -> Vec<LocationPreset> {
    vec![
        LocationPreset {
            ...
            center: [-0.4, -0.6],
            zoom: 0.6,
            fractal_type: FractalType::BurningShip, power: Some(2.0),
        },
        LocationPreset {
            name: "The Ship",
            center: [-1.762, -0.028],
        ...
        LocationPreset {
            ...
            center: [0.0, 0.0],
            zoom: 0.6,
            fractal_type: FractalType::BurningShip, power: Some(3.0),
        },
        LocationPreset {
            name: "Quartic (z⁴)",
            center: [0.0, 0.0],
            zoom: 0.6,
            fractal_type: FractalType::BurningShip, power: Some(4.0),
        },
        LocationPreset {
            name: "Quintic (z⁵)",
            center: [0.0, 0.0],
            zoom: 0.6,
            fractal_type: FractalType::BurningShip, power: Some(5.0),
        },
    ]
}
