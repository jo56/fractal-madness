...
const FRACTAL_CELTIC: u32 = 4u;
// Julia variants
const FRACTAL_BUFFALO_JULIA: u32 = 5u;
const FRACTAL_CELTIC_JULIA: u32 = 6u;
// Advanced fractals
const FRACTAL_NEWTON: u32 = 7u;
const FRACTAL_PHOENIX: u32 = 8u;
...
// Buffalo Julia: z = abs(z)^2 - z + c (starting from z_init)
